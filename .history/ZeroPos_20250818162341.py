...
CAMERA_ID = 1  # Usually 0 for built-in webcam, 1 for external
FPS_TARGET = 30
DISPLAY_SCALE = 0.75  # Scale factor for display (0.5 = half size)
...
def main():
    ...
    while True:
        ...
        if DISPLAY_SCALE != 1.0:
            display_size = (int(result.shape[1] * DISPLAY_SCALE), 
                          int(result.shape[0] * DISPLAY_SCALE))
