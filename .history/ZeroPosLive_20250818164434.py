...
def process_frame(frame):
    ...
    # Draw center circles regardless of contour detection
    center_x = int(W / 2)  # Center X of frame
    center_y = int(H / 2)  # Center Y of frame
    
    # Draw the two reference circles
    cv2.circle(vis, (center_x, center_y), int(330 * INPUT_SCALE), (0, 255, 0), 2)  # Inner circle (green)
    cv2.circle(vis, (center_x, center_y), int(420 * INPUT_SCALE), (0, 0, 255), 2)  # Outer circle (red)
