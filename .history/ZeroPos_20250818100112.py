...
MIN_AREA = 100
R_MIN, R_MAX = 8, 30                 # min/max hole radius in pixels (adjust if needed)
CIRC_MIN = 0.75                      # circularity threshold (≈1.0 for perfect circle)
ROUND_RANGE = (0.70, 1.20)           # area/(pi*r^2) tolerance around a circle
# ---------------------------------------------
