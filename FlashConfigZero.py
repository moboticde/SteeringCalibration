...
ZERO_CONFIG_PATH_1 = Path("/home/mobotic/Internal Projects/StCalibration-Linux/resources/ic_mu_miControl_enc.cfg")
ZERO_CONFIG_PATH_2 = Path("/home/mobotic/Internal Projects/StCalibration-Linux/resources/ic-mu_MU_enc.cfg")
ENCODER_MUX_STATES = ((1, True), (2, False))
ZERO_PRESET_PLAN = (
    (1, ENCODER_MUX_STATES[0][1], ZERO_CONFIG_PATH_1, 0),
    (2, ENCODER_MUX_STATES[1][1], ZERO_CONFIG_PATH_2, 1024),
)
...
def write_des_zero_process(
    ...
    try:
        ...
        print(
            ...
            "calibration-mapped encoder 1 preset=0 and encoder 2 preset=1024 "
